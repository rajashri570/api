...
class StudentEnrolled(db.Model):
    ...
    joindate = db.Column(db.Date, default=datetime.date.today)


def get_last_day_of_current_month():
    today = datetime.today()
    last_day = datetime.monthrange(today.year, today.month)[1]
...
class FeesPaymentModel(db.Model):
    ...
    paymentDate = db.Column(db.Date,default=datetime.date.today)